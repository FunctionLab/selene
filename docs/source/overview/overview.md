# Functional overview of the Selene software development kit

The SDK, formally known as `selene_sdk`, is an extensible Python package intended to ease development of new programs that leverage sequence-level models through code reuse.
