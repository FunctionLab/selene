...
class ModelController(object):
    ...
    def train_and_validate(self, n_epochs):
        ...
        report_stats_handle = open(
            os.path.join(self.output_dir, "runner_stats.txt"),
            mode="w")
    ...
    def train(self, epoch):
        ...
        for batch_number in range(self.n_train_batch_per_epoch):
            info = self.run_batch_training(avg_losses_train, batch_number)
    ...
    def validate(self, epoch):
        ...
        collect_predictions = []
        for batch_number, (inputs, targets) in enumerate(self._validation_data):
    ...
    def register_plugin(self, plugin):
        """TODO: what does a Plugin need to have/do?
        """
