...
wget https://zenodo.org/record/1445552/files/online_sampler_data.tar.gz
...
# wget https://zenodo.org/record/1445552/files/chromatin_profiles.tar.gz
...
wget https://zenodo.org/record/1445552/files/DeepSEA_data.tar.gz
...
wget https://zenodo.org/record/1445552/files/model_comparison_data.tar.gz
...
# wget https://zenodo.org/record/1445552/files/mat_training_outputs.tar.gz

# tar -xzvf mat_training_outputs.tar.gz

# Training using the chromatin profiles and the intervals sampler

# wget https://zenodo.org/record/1445552/files/online_sampler_outputs.tar.gz
...
# wget https://zenodo.org/record/1445552/files/evaluation_outputs.tar.gz
