...
#endif
#include <math.h>
#define __PYX_HAVE__selene__sequences___genome
#define __PYX_HAVE_API__selene__sequences___genome
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
/* "selene/sequences/_genome.pyx":6
 * cimport numpy as np
 * 
 ...
 */
typedef __pyx_t_5numpy_float32_t __pyx_t_6selene_9sequences_7_genome_FDTYPE_t;
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'selene.sequences._genome' */
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_6selene_9sequences_7_genome_FDTYPE_t = { "FDTYPE_t", NULL, sizeof(__pyx_t_6selene_9sequences_7_genome_FDTYPE_t), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "selene.sequences._genome"
int __pyx_module_is_main_selene__sequences___genome = 0;

/* Implementation of 'selene.sequences._genome' */
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_RuntimeError;
static PyObject *__pyx_pf_6selene_9sequences_7_genome__fast_sequence_to_encoding(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_sequence, PyObject *__pyx_v_bases_encoding); /* proto */
...
static char __pyx_k_16[] = "_fast_sequence_to_encoding";
static char __pyx_k_17[] = "/home/kc31/fi-projects/selene/selene/sequences/_genome.pyx";
static char __pyx_k_18[] = "selene.sequences._genome";
...
static char __pyx_k__sequence_len[] = "sequence_len";
static char __pyx_k__bases_encoding[] = "bases_encoding";
...
static PyObject *__pyx_n_s__bases_encoding;
...
static PyObject *__pyx_n_s__sequence_len;
...
/* Python wrapper */
static PyObject *__pyx_pw_6selene_9sequences_7_genome_1_fast_sequence_to_encoding(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_6selene_9sequences_7_genome_1_fast_sequence_to_encoding = {__Pyx_NAMESTR("_fast_sequence_to_encoding"), (PyCFunction)__pyx_pw_6selene_9sequences_7_genome_1_fast_sequence_to_encoding, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)};
static PyObject *__pyx_pw_6selene_9sequences_7_genome_1_fast_sequence_to_encoding(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_sequence = 0;
  PyObject *__pyx_v_bases_encoding = 0;
  int __pyx_lineno = 0;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__sequence,&__pyx_n_s__bases_encoding,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__bases_encoding)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_fast_sequence_to_encoding", 1, 2, 2, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_fast_sequence_to_encoding") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_bases_encoding = ((PyObject*)values[1]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_fast_sequence_to_encoding", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("selene.sequences._genome._fast_sequence_to_encoding", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_sequence), (&PyString_Type), 1, "sequence", 1))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_bases_encoding), (&PyDict_Type), 1, "bases_encoding", 1))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_6selene_9sequences_7_genome__fast_sequence_to_encoding(__pyx_self, __pyx_v_sequence, __pyx_v_bases_encoding);
  goto __pyx_L0;
  __pyx_L1_error:;
  __pyx_r = NULL;
  __pyx_L0:;
...
/* "selene/sequences/_genome.pyx":10
 * @cython.boundscheck(False) # turn off bounds-checking for entire function
...
static PyObject *__pyx_pf_6selene_9sequences_7_genome__fast_sequence_to_encoding(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_sequence, PyObject *__pyx_v_bases_encoding) {
  ...
  /* "selene/sequences/_genome.pyx":11
 * @cython.wraparound(False)  # turn off negative index wrapping for entire function
 * def _fast_sequence_to_encoding(str sequence, dict bases_encoding):
 *     cdef int sequence_len = len(sequence)             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[FDTYPE_t, ndim=2] encoding = np.zeros(
 ...
 */
  __pyx_t_1 = PyObject_Length(((PyObject *)__pyx_v_sequence)); if (unlikely(__pyx_t_1 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_sequence_len = __pyx_t_1;

  /* "selene/sequences/_genome.pyx":12
 * def _fast_sequence_to_encoding(str sequence, dict bases_encoding):
 *     cdef int sequence_len = len(sequence)
 *     cdef np.ndarray[FDTYPE_t, ndim=2] encoding = np.zeros(             # <<<<<<<<<<<<<<
 *         (sequence_len, 4), dtype=np.float32)
 ...
 */
  ...
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s__zeros); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "selene/sequences/_genome.pyx":13
 *     cdef int sequence_len = len(sequence)
 *     cdef np.ndarray[FDTYPE_t, ndim=2] encoding = np.zeros(
 *         (sequence_len, 4), dtype=np.float32)             # <<<<<<<<<<<<<<
 *     cdef int index
 *     cdef str base
 */
  __pyx_t_2 = PyInt_FromLong(__pyx_v_sequence_len); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
 ...
 *     cdef str base
 */
  __pyx_t_5 = __Pyx_GetModuleGlobalName(__pyx_n_s__np); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s__float32); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  if (PyDict_SetItem(__pyx_t_4, ((PyObject *)__pyx_n_s__dtype), __pyx_t_6) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = PyObject_Call(__pyx_t_3, ((PyObject *)__pyx_t_2), ((PyObject *)__pyx_t_4)); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  ...
  __pyx_t_7 = ((PyArrayObject *)__pyx_t_6);
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_encoding.rcbuffer->pybuffer, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo_nn___pyx_t_6selene_9sequences_7_genome_FDTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
  ...
  /* "selene/sequences/_genome.pyx":17
 *     cdef str base
 * 
 ...
 */
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(((PyObject *)((PyObject*)(&PyString_Type))), __pyx_n_s__upper); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  ...
  PyTuple_SET_ITEM(__pyx_t_4, 0, ((PyObject *)__pyx_v_sequence));
  __Pyx_GIVEREF(((PyObject *)__pyx_v_sequence));
  __pyx_t_2 = PyObject_Call(__pyx_t_6, ((PyObject *)__pyx_t_4), NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_4)); __pyx_t_4 = 0;
  if (!(likely(PyString_CheckExact(__pyx_t_2))||((__pyx_t_2) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected str, got %.200s", Py_TYPE(__pyx_t_2)->tp_name), 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(((PyObject *)__pyx_v_sequence));
  __pyx_v_sequence = ((PyObject*)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "selene/sequences/_genome.pyx":19
 *     sequence = str.upper(sequence)
 * 
 *     for index in range(sequence_len):             # <<<<<<<<<<<<<<
 *         base = sequence[index]
 ...
 */
  __pyx_t_8 = __pyx_v_sequence_len;
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    __pyx_v_index = __pyx_t_9;

    /* "selene/sequences/_genome.pyx":20
 * 
 *     for index in range(sequence_len):
 *         base = sequence[index]             # <<<<<<<<<<<<<<
 *         if base in bases_encoding:
 ...
 */
    __pyx_t_2 = __Pyx_GetItemInt(((PyObject *)__pyx_v_sequence), __pyx_v_index, sizeof(int), PyInt_FromLong, 0, 0, 0); if (!__pyx_t_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    if (!(likely(PyString_CheckExact(__pyx_t_2))||((__pyx_t_2) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected str, got %.200s", Py_TYPE(__pyx_t_2)->tp_name), 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_XDECREF(((PyObject *)__pyx_v_base));
    __pyx_v_base = ((PyObject*)__pyx_t_2);
    __pyx_t_2 = 0;

    /* "selene/sequences/_genome.pyx":21
 *     for index in range(sequence_len):
 *         base = sequence[index]
 *         if base in bases_encoding:             # <<<<<<<<<<<<<<
 *             encoding[index, bases_encoding[base]] = 1
 *         else:
 */
    if (unlikely(((PyObject *)__pyx_v_bases_encoding) == Py_None)) {
      PyErr_SetString(PyExc_TypeError, "'NoneType' object is not iterable");
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    __pyx_t_10 = (__Pyx_PyDict_Contains(((PyObject *)__pyx_v_base), ((PyObject *)__pyx_v_bases_encoding), Py_EQ)); if (unlikely(__pyx_t_10 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (__pyx_t_10) {

      /* "selene/sequences/_genome.pyx":22
 *         base = sequence[index]
 *         if base in bases_encoding:
 *             encoding[index, bases_encoding[base]] = 1             # <<<<<<<<<<<<<<
 *         else:
 *             encoding[index, :] = 0.25
 */
      __pyx_t_2 = PyInt_FromLong(__pyx_v_index); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      if (unlikely(((PyObject *)__pyx_v_bases_encoding) == Py_None)) {
        PyErr_SetString(PyExc_TypeError, "'NoneType' object is not subscriptable");
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __pyx_t_4 = __Pyx_PyDict_GetItem(((PyObject *)__pyx_v_bases_encoding), ((PyObject *)__pyx_v_base)); if (!__pyx_t_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      ...
      __pyx_t_2 = 0;
      __pyx_t_4 = 0;
      if (PyObject_SetItem(((PyObject *)__pyx_v_encoding), ((PyObject *)__pyx_t_6), __pyx_int_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(((PyObject *)__pyx_t_6)); __pyx_t_6 = 0;
      goto __pyx_L5;
    }
    /*else*/ {

      /* "selene/sequences/_genome.pyx":24
 *             encoding[index, bases_encoding[base]] = 1
 *         else:
 *             encoding[index, :] = 0.25             # <<<<<<<<<<<<<<
 *     return encoding
 */
      __pyx_t_6 = PyFloat_FromDouble(0.25); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_4 = PyInt_FromLong(__pyx_v_index); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      ...
      __pyx_t_4 = 0;
      if (PyObject_SetItem(((PyObject *)__pyx_v_encoding), ((PyObject *)__pyx_t_2), __pyx_t_6) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(((PyObject *)__pyx_t_2)); __pyx_t_2 = 0;
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    }
    __pyx_L5:;
  ...
  /* "selene/sequences/_genome.pyx":25
 *         else:
 *             encoding[index, :] = 0.25
 *     return encoding             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s__bases_encoding, __pyx_k__bases_encoding, sizeof(__pyx_k__bases_encoding), 0, 0, 1, 1},
  ...
  {&__pyx_n_s__sequence_len, __pyx_k__sequence_len, sizeof(__pyx_k__sequence_len), 0, 0, 1, 1},
 ...
 *     cdef np.ndarray[FDTYPE_t, ndim=2] encoding = np.zeros(
 */
  __pyx_k_tuple_14 = PyTuple_Pack(6, ((PyObject *)__pyx_n_s__sequence), ((PyObject *)__pyx_n_s__bases_encoding), ((PyObject *)__pyx_n_s__sequence_len), ((PyObject *)__pyx_n_s__encoding), ((PyObject *)__pyx_n_s__index), ((PyObject *)__pyx_n_s__base)); if (unlikely(!__pyx_k_tuple_14)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_k_tuple_14);
  __Pyx_GIVEREF(((PyObject *)__pyx_k_tuple_14));
  __pyx_k_codeobj_15 = (PyObject*)__Pyx_PyCode_New(2, 0, 6, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_k_tuple_14, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_17, __pyx_n_s_16, 10, __pyx_empty_bytes); if (unlikely(!__pyx_k_codeobj_15)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_genome(void); /*proto*/
PyMODINIT_FUNC init_genome(void)
#else
PyMODINIT_FUNC PyInit__genome(void); /*proto*/
PyMODINIT_FUNC PyInit__genome(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__genome(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("_genome"), __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "selene.sequences._genome")) {
      if (unlikely(PyDict_SetItemString(modules, "selene.sequences._genome", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  ...
  #endif
  if (__pyx_module_is_main_selene__sequences___genome) {
  ...
  /* "selene/sequences/_genome.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 * cimport cython
 */
 ...
 *     cdef np.ndarray[FDTYPE_t, ndim=2] encoding = np.zeros(
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6selene_9sequences_7_genome_1_fast_sequence_to_encoding, NULL, __pyx_n_s_18); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_16, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init selene.sequences._genome", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init selene.sequences._genome");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
