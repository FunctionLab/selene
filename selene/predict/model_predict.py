    ...
    def _initialize_reporters(self,
        ...
        if "diffs" in save_data:
            filename = os.path.join(
                output_dir, "{0}_diffs.txt".format(filename_prefix))
