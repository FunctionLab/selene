...
class TrainModel(object):
    ...
    n_validation_samples : int or None, optional
        ...
        used is the IntervalsSampler or RandomSampler, we will retrieve 32000
        validation samples. If None and using MatFileSampler, we will use all
    ...
    n_test_samples : int or None, optional
        ...
        IntervalsSampler, the size of the test set is the number of test
        intervals we can sample from. If None and using RandomSampler,
        the size is 0.05 * # possible positions in the test partition
        of the genome. If None and using MatFileSampler, we will use all
